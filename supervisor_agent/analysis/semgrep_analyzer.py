    ...
    def analyze_repository(
        ...
        try:
            ...
            exclusions = [
                ...
                "dist", "build", ".svelte-kit", "coverage", ".nyc_output",
            ...
            raise RuntimeError(f"Semgrep analysis timed out after {timeout_seconds} seconds")
        ...
        try:
            ...
            for ruleset in rulesets:
                ...
                stat = RulesetStats(
                    ...
                    error_count=len([f for f in ruleset_findings if f.severity == SeverityLevel.ERROR]),
                    warning_count=len([f for f in ruleset_findings if f.severity == SeverityLevel.WARNING]),
                    info_count=len([f for f in ruleset_findings if f.severity == SeverityLevel.INFO])
                )
