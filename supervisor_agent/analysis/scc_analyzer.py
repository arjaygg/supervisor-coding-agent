...
class SCCAnalyzer:
    ...
    def __init__(self, scc_binary_path: str = "scc"):
        ...
        self.supported_languages = {
            ...
            "JSON", "YAML", "HTML", "CSS", "Markdown", "Shell"
        }
    ...
    def analyze_repository(
        ...
        try:
            ...
            cmd = [
                ...
                "--count-as", "py:Python,ts:TypeScript,js:JavaScript,svelte:Svelte"
            ]
            
            # Add exclusions
            default_excludes = [
                "node_modules", ".git", "__pycache__", ".pytest_cache",
                "dist", "build", ".svelte-kit", ".vscode", ".idea",
    ...
    def get_language_insights(self, analysis_result: AnalysisResult) -> Dict[str, Any]:
        ...
        try:
            ...
            dominant = max(
                analysis_result.language_breakdown,
            ...
            if total_lines > 0:
                significant_languages = [
                    lang for lang in analysis_result.language_breakdown
    ...
    def _process_scc_output(
        ...
        try:
            ...
            repository_summary = {
                ...
                "primary_languages": [
                    lang.language for lang in sorted(
                        language_breakdown, 
                        key=lambda x: x.lines, 
                        reverse=True
                    )[:3]
                ...
                ) if total_metrics.comments > 0 else float('inf'),
    ...
    def _calculate_maintainability_score(self, analysis_result: AnalysisResult) -> int:
        ...
        try:
            ...
            if analysis_result.file_details:
                large_files = [
                    f for f in analysis_result.file_details 
                    if f.lines > 500
                ]
                if large_files:
    ...
    def _generate_recommendations(
        ...
        try:
            ...
            if dominant_lang == "JavaScript":
                ts_files = sum(
                    1 for lang in analysis_result.language_breakdown
