...
class ProviderWebSocketManager:
    ...
    def _should_send_to_client(self, websocket: WebSocket, update_type: str, data: Any) -> bool:
        ...
        if "providers" in filters:
            ...
            if update_type == "provider_health" and data.get("provider_id") not in provider_filter:
                return False
        ...
        if "min_severity" in filters:
            ...
            if severity_levels.get(data_severity, 1) < severity_levels.get(min_severity, 1):
                return False
    ...
    def _detect_changes(self, old_status: Dict, new_status: Dict) -> List[Dict[str, Any]]:
                ...
                if old_quota_status != new_quota_status:
                    changes.append({
                        ...
                        "data": {
                            ...
                            "usage_percentage": new_quota.get("usage_percentage", 0),
                            "requests_remaining": new_quota.get("requests_remaining", 0),
