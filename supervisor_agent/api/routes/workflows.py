...
class WorkflowCreateRequest(BaseModel):
    ...
    dependencies: List[Dict[str, Any]] = Field(default=[], description="Task dependencies")
...
class WorkflowExecuteRequest(BaseModel):
    ...
    triggered_by: Optional[str] = Field(None, description="Who/what triggered the execution")
