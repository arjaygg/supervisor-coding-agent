...
from supervisor_agent.db.models import ChatThread, ChatMessage
...
class TestChatIntegration:
    ...
    def test_get_chat_threads(self, client):
        ...
        assert any(thread["title"] == thread_data["title"] for thread in data["threads"])
    ...
    def test_send_message_to_thread(self, client):
        ...
        response = client.post(f"/api/v1/chat/threads/{thread_id}/messages", json=message_data)
        assert response.status_code == 200
    ...
    def test_chat_api_endpoints_exist(self, client):
        ...
        response = client.get("/api/v1/chat/threads/00000000-0000-0000-0000-000000000000")
