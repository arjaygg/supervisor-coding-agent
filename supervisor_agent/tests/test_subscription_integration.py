...
class TestIntelligentTaskProcessor:
    ...
    async def test_process_task_new_request(self, task_processor, mock_task):
        ...
        mock_agent_processor = AsyncMock(return_value={
            "success": True,
    ...
    async def test_force_process_pending(self, task_processor):
        ...
        await task_processor.subscription_intelligence.batch_processor.add_request({
            "task": mock_task,
            "_processor": mock_agent_processor
        })
        ...
        assert task_processor.subscription_intelligence.batch_processor.current_batch == []
...
class TestCeleryTaskIntegration:
    ...
    async def test_enhanced_process_single_task(self):
        ...
        with patch('supervisor_agent.queue.tasks.get_db') as mock_get_db, \
...
class TestQuotaIntegration:
    ...
    async def test_automatic_quota_reset(self, task_processor):
        ...
        task_processor.subscription_intelligence.usage_reset_time = datetime.now() - timedelta(hours=1)
...
class TestPerformanceOptimizations:
    ...
    def test_memory_usage_tracking(self, task_processor):
        ...
        cache_stats = task_processor.subscription_intelligence.deduplicator.get_cache_stats()
    ...
    async def test_batch_efficiency_metrics(self, task_processor):
        ...
        batch_stats = task_processor.subscription_intelligence.batch_processor.get_batch_stats()
