...
class TestTokenEstimator:
    ...
    def test_estimate_cost_default_model(self):
        ...
        cost = TokenEstimator.estimate_cost(
            1000, 500
        )  # 1k prompt, 500 completion tokens
    ...
    def test_estimate_cost_specific_model(self):
        ...
        cost_sonnet = TokenEstimator.estimate_cost(
            1000, 500, "claude-3-5-sonnet-20241022"
        )
        cost_haiku = TokenEstimator.estimate_cost(
            1000, 500, "claude-3-5-haiku-20241022"
        )
    ...
    def test_estimate_prompt_tokens_with_context(self):
        ...
        context = {
            "previous_result": "Some previous analysis",
...
class TestCostTracker:
    ...
    async def test_track_task_execution(self, test_db, sample_task):
        ...
        with patch(
            "supervisor_agent.db.crud.CostTrackingCRUD.create_cost_entry"
        ) as mock_create:
            ...
            with patch(
                "supervisor_agent.core.cost_tracker.CostTracker._update_usage_metrics"
            ):
                # Track execution
    ...
    def test_get_cost_summary(self, test_db):
        ...
        with patch(
            "supervisor_agent.db.crud.CostTrackingCRUD.get_cost_summary"
        ) as mock_summary:
...
async def test_cost_tracking_integration():
    ...
    with patch(
        "supervisor_agent.core.cost_tracker.cost_tracker.track_task_execution"
    ) as mock_track:
