...
class TestClaudeCliIntegration:
    ...
    def test_mock_mode_configuration(self):
        ...
        with patch.dict(os.environ, {'CLAUDE_CLI_PATH': 'mock', 'CLAUDE_API_KEYS': 'mock-key-1,mock-key-2'}):
    ...
    async def test_mock_response_generation(self):
        ...
        task_types = ["PR_REVIEW", "CODE_ANALYSIS", "BUG_FIX", "FEATURE", "REFACTOR", "ISSUE_SUMMARY"]
