...
class CostEstimate:
    ...
    @classmethod
    def from_tokens(cls, tokens: int, cost_per_token: float, model: str = None) -> "CostEstimate":
...
class QuotaExceededError(ProviderError):
    ...
    def __init__(self, message: str, provider_id: str = None, quota_reset_time: datetime = None):
...
class RateLimitError(ProviderError):
    ...
    def __init__(self, message: str, provider_id: str = None, retry_after_seconds: int = None):
