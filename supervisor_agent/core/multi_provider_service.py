...
class MultiProviderService:
    ...
    def __init__(self):
        ...
        self.subscription_intelligence: Optional[
            MultiProviderSubscriptionIntelligence
        ] = None
    ...
    async def process_task(
        ...
        if routing_strategy:
            try:
                ...
                logger.warning(
                    f"Unknown routing strategy: {routing_strategy}, using default"
                )
    ...
    async def get_analytics(self) -> Dict[str, Any]:
        ...
        try:
            analytics = (
                await self.subscription_intelligence.get_cross_provider_analytics()
            )
    ...
    async def _register_providers_from_config(self) -> None:
        ...
        try:
            ...
            for config in provider_configs:
                ...
                success = await self.register_provider(
