...
def upgrade():
    ...
    op.create_index(op.f('ix_provider_metrics_provider_id'), 'provider_metrics', ['provider_id'], unique=False)
    ...
    with op.batch_alter_table('tasks') as batch_op:
        ...
        batch_op.create_foreign_key('fk_tasks_provider', 'providers', ['provider_id'], ['id'])
