...
{:else}
  <div class="space-y-2">
    {#each tasks as task (task.id)}
      <div
        class="list-item cursor-pointer focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-inset {task.status ===
        'PENDING'
  ...
  <div class="hidden md:block mt-4 text-xs text-gray-500">
    <p>
      Keyboard shortcuts: <kbd class="bg-gray-700 px-1 rounded">A</kbd> Approve,
      <kbd class="bg-gray-700 px-1 rounded">R</kbd>
      Reject, <kbd class="bg-gray-700 px-1 rounded">Enter</kbd> View Details
    </p>
  </div>
{/if}
