...
describe('TaskList', () => {
  ...
  it('should show approve/reject buttons for pending tasks', () => {
    const { getByText } = render(TaskList, { props: { tasks: [mockTasks[0]] } });
  ...
  it('should not show approve/reject buttons for non-pending tasks', () => {
    const { queryByText } = render(TaskList, { props: { tasks: [mockTasks[1]] } });
  ...
  it('should handle keyboard shortcuts for approval', async () => {
    ...
    const { container, component } = render(TaskList, { props: { tasks: [mockTasks[0]] } });
  ...
  it('should emit events when approve/reject buttons are clicked', async () => {
    const { getByText, component } = render(TaskList, { props: { tasks: [mockTasks[0]] } });
