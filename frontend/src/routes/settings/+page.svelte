...
<div class="container mx-auto px-4 py-8">
  <div class="mb-8">
    ...
    <p class="text-gray-400">
      Configure system preferences and view system information
    </p>
  </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div class="space-y-6">
        ...
        <div class="flex gap-4">
          <button on:click={saveSettings} disabled={saving} class="btn-primary">
            {saving ? "Saving..." : "Save Settings"}
          </button>

          <button on:click={resetToDefaults} class="btn-outline">
            Reset to Defaults
          </button>
        </div>
        ...
        {#if saveMessage}
          <div
            class="p-3 rounded-lg {saveMessage.includes('Error')
      ...
      <div class="space-y-6">
          ...
          {#if systemInfo}
            <div class="space-y-3">
              ...
              <div class="info-item">
                ...
                <span
                  class="info-value capitalize {systemInfo.status === 'healthy'
                    ? 'text-green-400'
                    : 'text-yellow-400'}"
                >
              ...
              <div class="info-item">
                ...
                <span class="info-value"
                  >{formatUptime(systemInfo.timestamp)}</span
                >
              </div>
                  ...
                  <div class="space-y-2">
                    {#each Object.entries(systemInfo.components) as [component, status]}
                      <div class="flex justify-between items-center">
                        ...
                        >
                        <span
                          class="text-sm {status.status === 'healthy'
                            ? 'text-green-400'
                            : 'text-red-400'}"
                        >
        ...
        <div class="settings-section">
          ...
          <div class="space-y-3">
            ...
            <a
              href="https://github.com/arjaygg/supervisor-coding-agent"
              target="_blank"
              class="help-link"
            >
